...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(static/images/bg_2.jpg);" data-aos="fade">
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-end">
                <div class="col-md-4 text-center text-md-right pt-5 pt-md-0">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12 col-lg-5 text-center pl-md-5">
                    ...
                    <p><a href="shop.jsp" class="btn btn-primary btn-sm">Shop Now</a></p>
                </div>
            </div>
        </div>
    </div>
